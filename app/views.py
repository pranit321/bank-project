...
def insert_bank(self):
    with open('C:\\Users\\prani\\OneDrive\\Desktop\\django_projects\\pranit\\Scripts\\Bank_project\\app\\bank.csv','r') as FO:
        IOD=csv.reader(FO)
        for i in IOD:
            bn=i[0].strip()
...
def insert_branch(self):
    with open('C:\\Users\\prani\\OneDrive\\Desktop\\django_projects\\pranit\\Scripts\\Bank_project\\app\\branch1.csv','r') as FO:
        IOD=csv.reader(FO)
        next(IOD)
        for i in IOD:
            bn=i[0]
